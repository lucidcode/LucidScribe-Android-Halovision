...
public class VisionActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			Log.e(VisionActivity.LOG_TAG, "onCreate: " + e.getMessage());
		}
	}
                ...
                if (Algorithm.equals("Motion Detector"))
                {
                	if (diff >= FrameThreshold)
                	{
                		if (Track.equals("Lucid Scribe Trigger"))
                		{
		            		...
		            		else if( TaskerIntent.testStatus( getApplicationContext() ).equals( TaskerIntent.Status.NotInstalled ) ){
		            			Toast.makeText(getApplicationContext(), "Tasker not installed!", Toast.LENGTH_SHORT).show();
		            		}
		            		else if( TaskerIntent.testStatus( getApplicationContext() ).equals( TaskerIntent.Status.NotEnabled ) ){
		            			Toast.makeText(getApplicationContext(), "Tasker not enabled!", Toast.LENGTH_SHORT).show();
		            		}
		            		else if( TaskerIntent.testStatus( getApplicationContext() ).equals( TaskerIntent.Status.NoPermission ) ){
		            			Toast.makeText(getApplicationContext(), "App has no Tasker permission!", Toast.LENGTH_SHORT).show();
		            		}
		            		else if( TaskerIntent.testStatus( getApplicationContext() ).equals( TaskerIntent.Status.AccessBlocked ) ){
		            			Toast.makeText(getApplicationContext(), "External tasks not allowed!", Toast.LENGTH_SHORT).show();
		            		}
		            		else if( TaskerIntent.testStatus( getApplicationContext() ).equals( TaskerIntent.Status.NoReceiver ) ){
		            			Toast.makeText(getApplicationContext(), "No Tasker receiver!", Toast.LENGTH_SHORT).show();
		            		}
		                	else
		                	{
		            			Toast.makeText(getApplicationContext(), "Tasker error", Toast.LENGTH_SHORT).show();
		                	}
	                	}
                		else
                		{
